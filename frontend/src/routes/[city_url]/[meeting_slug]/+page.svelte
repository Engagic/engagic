...
<style>
	...
	.meeting-summary :global(h1) { font-size: var(--text-xl); }
	.meeting-summary :global(h2) { font-size: var(--text-lg); }
	.meeting-summary :global(h3) { font-size: var(--text-base); }
	.meeting-summary :global(h4) { font-size: var(--text-sm); }
