...
export const getPlatformMetrics = apiClient.getPlatformMetrics.bind(apiClient);
...
export const getGlobalHappening = apiClient.getGlobalHappening.bind(apiClient);
