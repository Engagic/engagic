...
def process_meeting(
    ...
    meeting_data = {
        'packet_url': urls_to_process[0] if len(urls_to_process) == 1 else urls_to_process,
...
def main():
    ...
    parser.add_argument('--exclude-city', action='append', dest='exclude_cities',
