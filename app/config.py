...
class Config:
    ...
    def __init__(self):
        ...
        self.LOCATIONS_DB_PATH = os.getenv("ENGAGIC_LOCATIONS_DB", f"{self.DB_DIR}/locations.db")
        self.MEETINGS_DB_PATH = os.getenv("ENGAGIC_MEETINGS_DB", f"{self.DB_DIR}/meetings.db")
        self.ANALYTICS_DB_PATH = os.getenv("ENGAGIC_ANALYTICS_DB", f"{self.DB_DIR}/analytics.db")
        ...
        # CORS settings
        self.ALLOWED_ORIGINS = self._parse_origins(os.getenv("ENGAGIC_ALLOWED_ORIGINS", 
        ...
        self.BACKGROUND_PROCESSING = os.getenv("ENGAGIC_BACKGROUND_PROCESSING", "true").lower() == "true"
        self.SYNC_INTERVAL_HOURS = int(os.getenv("ENGAGIC_SYNC_INTERVAL_HOURS", "72"))  # 3 days
        self.PROCESSING_INTERVAL_HOURS = int(os.getenv("ENGAGIC_PROCESSING_INTERVAL_HOURS", "2"))
    ...
    def _validate(self):
        ...
        for db_path in [self.LOCATIONS_DB_PATH, self.MEETINGS_DB_PATH, self.ANALYTICS_DB_PATH]:
        ...
        if not os.path.exists(os.path.dirname(self.LOG_PATH)):
            logger.warning(f"Log directory does not exist: {os.path.dirname(self.LOG_PATH)}")
